...
### 🌐 **Source Information**
- **Canon Japan URL**: [View Official Page](https://personal.canon.jp/product/camera/rf/rf100-300-f28l/spec)
...
![MTF Chart](../../canon_mtf_data/rf_lenses/RF100_300mm_F2.8_L_IS_USM/mtf_spec_mtf.png)
...
![Construction Diagram](../../canon_mtf_data/rf_lenses/RF100_300mm_F2.8_L_IS_USM/construction_spec_lens_construction.png)
...
### 📝 **Category Analysis**
- **Lens Type**: Zoom Lens
- **Focal Length**: 100-300mm (Zoom)
- **Zoom Ratio**: 3.0x
- **Maximum Aperture**: f/100.0-300.0 (Variable)
...
### 🔗 **External Resources**
- **[Canon Japan Product Page](https://personal.canon.jp/product/camera/rf/rf100-300-f28l/spec)** - Official specifications
