...
### 🌐 **Source Information**
- **Canon Japan URL**: [View Official Page](https://personal.canon.jp/product/camera/rf/rf35-f18/spec)
...
![MTF Chart](../../canon_mtf_data/rf_lenses/RF35mm_F1.8_MACRO_IS_STM/mtf_spec_mtf.png)
...
![Construction Diagram](../../canon_mtf_data/rf_lenses/RF35mm_F1.8_MACRO_IS_STM/construction_spec_lens_construction.png)
...
- **Maximum Aperture**: f/35.0 (Constant)
- **Features**: Image Stabilization, Stepper Motor, Macro Capability
...
### 🔗 **External Resources**
- **[Canon Japan Product Page](https://personal.canon.jp/product/camera/rf/rf35-f18/spec)** - Official specifications
